(()=>{var v=function(){function o(e){this.element=e,this.onMouseDown=this.onMouseDown.bind(this),this.onScrollEnd=this.onScrollEnd.bind(this),this.onEnd=this.onEnd.bind(this),this.onMouseMove=this.onMouseMove.bind(this),this.init()}return o.prototype.init=function(){this.element.addEventListener("mousedown",this.onMouseDown),this.element.addEventListener("mouseup",this.onEnd),this.element.addEventListener("mouseleave",this.onEnd),this.element.addEventListener("mousemove",this.onMouseMove)},o.prototype.onMouseDown=function(e){this.isActive=!0,this.start={y:e.pageY-this.element.offsetTop,x:e.pageX-this.element.offsetLeft},this.scroll={top:this.element.scrollTop,left:this.element.scrollLeft},this.element.addEventListener("scrollend",this.onScrollEnd,{passive:!1,capture:!0})},o.prototype.onScrollEnd=function(e){e.preventDefault(),e.stopPropagation()},o.prototype.onEnd=function(){this.isActive=!1;for(var e=0;e<this.element.childNodes.length;e++)this.element.childNodes[e].style.pointerEvents="",this.element.childNodes[e].style.userSelect="",this.element.childNodes[e].style.removeProperty("pointerEvents"),this.element.childNodes[e].style.removeProperty("userSelect");this.element.removeEventListener("scrollend",this.onScrollEnd,{capture:!0}),this.element.dispatchEvent(new Event("scrollend"))},o.prototype.onMouseMove=function(e){if(this.isActive){if(e.preventDefault(),e.stopPropagation(),this.start.x<e.pageX-this.element.offsetLeft-2||this.start.y<e.pageY-this.element.offsetTop-2)for(var t=0;t<this.element.childNodes.length;t++)this.element.childNodes[t].style.pointerEvents="none",this.element.childNodes[t].style.userSelect="none";var n=e.pageX-this.element.offsetLeft,s=e.pageY-this.element.offsetTop,i=n-this.start.x,r=s-this.start.y;this.element.scrollTo({top:this.scroll.top-r,left:this.scroll.left-i})}},o}(),l=v;var m=function(){function o(e,t){this.element=e,this.config=t,this.onScrollEnd=this.onScrollEnd.bind(this),this.init()}return o.prototype.clear=function(){this.element.removeEventListener("scrollend",this.onScrollEnd)},o.prototype.snap=function(e){var t,n;this.element.scrollTo({left:e,behavior:"smooth"}),(n=(t=this.config).onSnap)===null||n===void 0||n.call(t,e)},o.prototype.init=function(){this.element.addEventListener("scrollend",this.onScrollEnd,{passive:!1})},o.prototype.onScrollEnd=function(){this.snap(this.getSnapPoint(this.element.scrollLeft))},o.prototype.getSnapPoint=function(e){return this.config.snaps.reduce(function(t,n){return Math.abs(n-e)<Math.abs(t-e)?n:t})},o}(),p=m;var g=function(o){var e;return((e=o.match(/[A-Z]{2,}(?=[A-Z][a-z]+[0-9]*|\b)|[A-Z]?[a-z]+[0-9]*|[A-Z]|[0-9]+/g))!==null&&e!==void 0?e:[]).join("-").toLowerCase()},h=g;var y=function(){var o=function(e,t){return o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(n,s){n.__proto__=s}||function(n,s){for(var i in s)Object.prototype.hasOwnProperty.call(s,i)&&(n[i]=s[i])},o(e,t)};return function(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");o(e,t);function n(){this.constructor=e}e.prototype=t===null?Object.create(t):(n.prototype=t.prototype,new n)}}(),S=function(o){y(e,o);function e(){var t=o.call(this)||this;return t.name=t.tagName.toLowerCase(),t}return e.register=function(t,n){window.customElements.define(h(t),n)},e.prototype.connectedCallback=function(){var t,n;this.load(),(t=this.onLoad)===null||t===void 0||t.call(this),(n=this.onInit)===null||n===void 0||n.call(this)},e.prototype.load=function(){if(this.innerHTML=this.html(),this.css){var t=document.createElement("style");t.innerHTML=`
        ...
        svg {
            pointer-events: none;
            position: absolute;
            height: `).concat(t.size-2,`px;
            width: `).concat(t.size,`px;
            top: 0;
            left: calc(50% - `).concat(t.size/2,"px + ").concat(t.spacing/2,`px);
            path {
                fill:none;
    ...
    `)},t}return e.prototype.onInit=function(){this.createStepElements(),this.snapToValue(),new l(this.querySelector("#temperature-picker-steps"))},e.prototype.attributeChangedCallback=function(t,n,s){t==="steps"&&(this.steps=JSON.parse(s)),t==="value"&&(this.value=JSON.parse(s)),t==="size"&&(this.size=JSON.parse(s),this.reload()),t==="spacing"&&(this.spacing=JSON.parse(s),this.reload())},e.prototype.createStepElements=function(){var t=this;if(this.steps){var n=this.querySelector("#temperature-picker-steps");if(n){for(var s=0,i=this.steps;s<i.length;s++){var r=i[s],a=document.createElement("button");a.classList.add("".concat(this.name,"-step")),this.value===r&&a.classList.add("selected"),a.setAttribute("value",r.toString()),a.innerText=r.toFixed(1).toLocaleString()+"\xB0",a.onclick=this.setValue.bind(this,r),n.append(a)}this.snaps=this.steps.map(function(_,f){return f*(t.size+t.spacing)}),this.createScrollSnaps()}}},e.prototype.snapToValue=function(){var t;if(this.scrollSnap&&this.steps&&this.value){var n=(t=this.steps.indexOf(this.value))!==null&&t!==void 0?t:0;this.scrollSnap.snap(n*(this.size+this.spacing))}},e.prototype.onSnap=function(t){this.setValue(this.steps[this.snaps.indexOf(t)])},e.prototype.setValue=function(t){this.value!==t&&(this.querySelector('[value="'.concat(this.value.toString(),'"]')).classList.remove("selected"),this.querySelector('[value="'.concat(t.toString(),'"]')).classList.add("selected"),this.setAttribute("value",t.toString()),this.dispatchEvent(new Event("value-change")),this.snapToValue())},e.prototype.createScrollSnaps=function(){this.scrollSnap&&this.scrollSnap.clear(),this.scrollSnap=new p(this.querySelector("#temperature-picker-steps"),{snaps:this.snaps,onSnap:this.onSnap.bind(this)})},e.observedAttributes=["steps","value","size","spacing"],e}(u),c=E;c.register("temperature-picker",c);})();
